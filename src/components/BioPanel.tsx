...
export const BioPanel = memo(function BioPanel() {
  return (
    <div className="md:absolute md:right-12 md:top-1/2 md:-translate-y-1/2 z-20 w-full md:w-[500px] md:mt-12 px-4 md:px-0 py-8 md:py-0 flex items-center md:items-start h-full md:h-auto">
      {/* Frosted Glass Panel */}
